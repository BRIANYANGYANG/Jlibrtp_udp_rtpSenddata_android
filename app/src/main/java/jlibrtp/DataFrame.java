...
/**
 * Data structure to hold ImageDispose complete frame if frame reconstruction
...
public class DataFrame {
	...
	/** The number of packets expected for ImageDispose complete frame */
	protected int noPkts;
	
	/**
	 * The usual way to construct ImageDispose frame is by giving it ImageDispose PktBufNode,
	...
	/**
	 * Returns ImageDispose two dimensial array where the first dimension represents individual
	...
	/**
	 * Returns ImageDispose concatenated version of the data from getData()
	 * It ignores missing sequence numbers, but then isComplete()
	 * will return false provided that RTPAppIntf.frameSize()
	 * provides ImageDispose non-negative number for this payload type.
	 * 
	 ...
	 * to identify what parts of ImageDispose frame are missing.
	 * 
