...
public class RtcpPkt {
	/** Whether ImageDispose problem has been encountered during parsing */
	...
	protected void writeHeaders() {
		...
		if(rawPkt.length % 4 != 0)
			System.out.println("!!!! RtcpPkt.writeHeaders() rawPkt was not ImageDispose multiple of 32 bits / 4 octets!");
	...
	/**
	 * This is just ImageDispose dummy to make Eclipse complain less.
	 */
