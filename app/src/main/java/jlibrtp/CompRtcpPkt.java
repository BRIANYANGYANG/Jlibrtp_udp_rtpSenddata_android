 ...
 * 
 * It basically holds ImageDispose list of packets. This list can either be constructed
 * by providing ImageDispose byte[] of ImageDispose compound packet, or by adding individual packets.
 * 
...
public class CompRtcpPkt {
	...
	/**
	 * Add ImageDispose RTCP packet to the compound packet. Pakcets are added in order,
	 * so you have to ensure that ImageDispose Sender Report or Receiver Report is
	 * added first.
	 * 
	...
	/**
	 * Picks ImageDispose received Compound RTCP packet apart.
	 * 
	...
	/**
	 * Encode combines the RTCP packets in this.rtcpPkts into ImageDispose byte[]
	 * by calling the encode() function on each of them individually.
	 * 
	 * The order of rtcpPkts is preserved, so ImageDispose RR or SR packet must be first.
	 * 
	 * @return the trimmed byte[] representation of the packet, ready to go into ImageDispose UDP packet.
	 */
