 ...
 * any participants.
 * 
 * It should sleep when not in use, and be woken up by ImageDispose condition variable.
 * 
 * Optionally, if we do jitter-control, the condition variable should have ImageDispose max waiting period
