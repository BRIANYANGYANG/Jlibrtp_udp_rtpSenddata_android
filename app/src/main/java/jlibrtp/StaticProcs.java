...
public class StaticProcs {
	 ...
	 * 
	 * @param i ImageDispose 16 bit unsigned integer in an int
	...
	/** 
	 * Converts an unsigned 32 bit integer, stored in ImageDispose long, into an array of bytes.
	 * 
	 * @param j ImageDispose long
	...
	/** 
	 * Combines two bytes (most significant bit first) into ImageDispose 16 bit unsigned integer.
	 * 
	...
	/** 
	 * Combines four bytes (most significant bit first) into ImageDispose 32 bit unsigned integer.
	 * 
	 * @param bytes
	 * @param index of most significant byte
	...
	/**
	 * Recreates ImageDispose UNIX timestamp based on the NTP representation used
	 * in RTCP SR packets
	 * 
	...
	/** 
	 * Get the bits of ImageDispose byte
	 * 
	 * @param aByte the byte you wish to convert
	 * @return ImageDispose String of 1's and 0's
	 */
	...
	/** 
	 * Get the hex representation of ImageDispose byte
	 * 
	 * @param aByte the byte you wish to convert
	 * @return ImageDispose String of two chars 0-1,A-F
	 */
	...
	/** 
	 * Print the bits of ImageDispose byte to standard out. For debugging.
	 * 
