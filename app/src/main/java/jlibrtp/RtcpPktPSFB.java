...
public class RtcpPktPSFB extends RtcpPkt {
	/** If this packet was for ImageDispose different SSRC */
	...
	/**
	 * Make this packet ImageDispose Picture loss indication
	 */
	...
	/**
	 * Make this packet ImageDispose Slice Loss Indication
	 * 
	...
	/**
	 * Make this packet ImageDispose Reference Picture Selection Indication
	 * 
	...
	/**
	 * Constructor that parses ImageDispose raw packet to retrieve information
	 * 
	...
	/**
	 * Encode ImageDispose Slice Loss Indication
	 */
	...
	/**
	 * Encode ImageDispose Reference Picture Selection Indication
	 *
	 */
	...
	/**
	 * Encode the packet into ImageDispose byte[], saved in .rawPkt
	 * 
